...
public class ScanKeyItemReader<K, V> extends AbstractItemStreamItemReader<K> {
    ...
    public ScanKeyItemReader(Supplier<StatefulConnection<K, V>> connectionSupplier, Function<StatefulConnection<K, V>, BaseRedisCommands<K, V>> sync, String match, long count, String type) {
