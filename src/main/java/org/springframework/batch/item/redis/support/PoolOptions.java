...
public class PoolOptions {
    ...
    public GenericObjectPool<StatefulRedisConnection<String, String>> create(RedisClient client) {
        return ConnectionPoolSupport.createGenericObjectPool(client::connect, config());
    }

    public GenericObjectPool<StatefulRedisClusterConnection<String, String>> create(RedisClusterClient client) {
        return ConnectionPoolSupport.createGenericObjectPool(client::connect, config());
    }

    public GenericObjectPool<? extends StatefulConnection<String, String>> create(RedisURI redisURI, boolean cluster) {
        if (cluster) {
            return create(RedisClusterClient.create(redisURI));
        }
