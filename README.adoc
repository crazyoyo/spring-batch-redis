...
image:https://github.com/redis-developer/spring-batch-redis/actions/workflows/early-access.yml/badge.svg["Build Status", link="https://github.com/{project-group}/{project-name}/actions/workflows/early-access.yml"]
