...
@Slf4j
public class ClusterKeyspaceNotificationItemReader extends AbstractKeyspaceNotificationItemReader<StatefulRedisClusterPubSubConnection<String, String>> implements RedisClusterPubSubListener<String, String> {

    public ClusterKeyspaceNotificationItemReader(Supplier<StatefulRedisClusterPubSubConnection<String, String>> connectionSupplier, List<String> pubSubPatterns, int queueCapacity) {
        super(connectionSupplier, pubSubPatterns, queueCapacity);
    }

    public ClusterKeyspaceNotificationItemReader(Supplier<StatefulRedisClusterPubSubConnection<String, String>> connectionSupplier, List<String> pubSubPatterns, BlockingQueue<String> queue) {
