...
@Slf4j
public class StreamItemReader extends ConnectionPoolItemStream<String, String>
	...
	public StreamItemReader(Supplier<StatefulConnection<String, String>> connectionSupplier,
	...
	public static class StreamItemReaderBuilder extends CommandBuilder<String, String, StreamItemReaderBuilder> {
		...
		public StreamItemReader build() {
			return new StreamItemReader(connectionSupplier(), poolConfig, sync(), count, block, consumerGroup, consumer,
					offset, ackPolicy);
		}
	}
