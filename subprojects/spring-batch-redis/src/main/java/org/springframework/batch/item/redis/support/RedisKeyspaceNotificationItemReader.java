...
@Slf4j
public class RedisKeyspaceNotificationItemReader extends AbstractKeyspaceNotificationItemReader<StatefulRedisPubSubConnection<String, String>> implements RedisPubSubListener<String, String> {
